...
//const char*    fParticleTitles   [fNumParticles] = {"p", "d", "t", "43e", "4He"};
...
//const char*    fSystemNames       [fNumSystems] = {"sys132", "sys108", "sys124", "sys112"};
...
//const char*    fSysCombNames         [fNumSysComb] = {"c0", "c1", "c2", "c3"};
...
//const char*    fLRNames  [fNumLRs] = {"a","l","r"};
...
const char*    fMultNames   [fNumMultOption] = {"45_100","45_54", "55_100"};
//const char*    fMultNames   [fNumMultOption] = {"45","45", "55"};
...
const char*    fCutTTANames  [fNumCutTTAs] = {"ttaAll","ttaRG0_20","ttaRG20_40","ttaRG40_60","ttaRG60_80","ttaST60","ttaLT60"};
//const char*    fCutTTANames  [fNumCutTTAs] = {"ta","t0","t2","t4","t6","s6","g6"};
