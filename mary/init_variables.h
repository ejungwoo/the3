...
auto fvar_eff      = variable("eff"  , "eff"  , "$$(cut0)", titles(fttl_main, "efficiency"                  , fttly_ntne), binning(200,0,0.15));
...
//auto fvar_ny_cm    = variable("ny_cm"  , "fy_cm/$$(ynn)", "$$(cut0)", titles(fttl_main, "y_{CM}/y_{NN}"        , fttly_ntne), binning(100,-1.,1.));
//auto fvar_ny_cm    = variable("ny_cm"  , "fy_cm/$$(ynn)", "$$(cut0)", titles(fttl_main, "y_{CM}/y_{NN}"        , fttly_ntne), binning(100,-.5,.5));
