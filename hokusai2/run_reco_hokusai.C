...
(
  ...
  //TString fBDC = "/home/ejungwoo/ridf",
  TString fBDC = "",
  ...
  Bool_t fSaveDecoder = 0,
  Bool_t fSaveHit = 0,
  Bool_t fSaveHelix = 0,
  Bool_t fSaveCluster = 0,
  Bool_t fSaveRecoTrack = 0,
  Bool_t fSaveRecoTrackList = 0,
  Bool_t fSaveVaddTrack = true,
  Bool_t fSaveVaddTrackList = 0,
...
{
  fName = Form("cutoff_%d",fChi2CutOff);
  ...
  genfitPID -> SetVertexMethod(Form("avf-smoothing:1-Tini:256-ratio:0.25-sigmacut:%d",fChi2CutOff)); // ...
  //genfitPID -> SetVertexMethod("avf-smoothing:1-Tini:256-ratio:0.25-sigmacut:9"); // 1% is assigned weight < 0.5
  //genfitPID -> SetVertexMethod("avf-smoothing:1-Tini:256-ratio:0.25-sigmacut:16"); // 0.03 %
  ...
  genfitPID -> SetFieldOffset(/*yOffset*/ -22.7013, /*zOffset*/ 58.);
  genfitVA -> SetFieldOffset(/*yOffset*/ -22.7013, /*zOffset*/ 58.);
