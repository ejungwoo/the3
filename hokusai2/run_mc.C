...
void run_mc
(
 TString outputDir = "/home/ejungwoo/data/mc/",
 TString name  = "embed_d_mom5_phi10_tta15",
 Int_t   nEvent = -1,
 //TString inputDir = "",
 //TString outputDir = "data/",
 //Bool_t  useFieldMapFile = kTRUE,
 //TString parName = "/home/ejungwoo/the3/hokusai2/analysisInputFiles/embedConfig/embed_d_875MeV_phi10_tta15.conf.par",
 TString parName = "/bwfefs/home/ejungwoo/the3/hokusai2/analysisInputFiles/embedConfig//embed_d_mom5_phi10_tta15.conf.par",
 Int_t   nSplit=0
)
{
  //////////////////////////////////////////////////////////
  ...
  gSystem -> Exec(TString("mkdir -p ")+outputDir);
...
//  AddIons(fRun, event);
  ...
  STDetector* fSpiRIT = new STDetector("STDetector", kTRUE);
  fSpiRIT -> SetPersistence(true);
...
*/
  ...
  //fDigiPar -> open(digiParFile.Data());
  //fDigiPar -> print();
